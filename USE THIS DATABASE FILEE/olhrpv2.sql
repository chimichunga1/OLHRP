...
MySQL - 5.7.21-log : Database - olhrp
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`olhrp` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `about_tbl`(`abt_id`,`mission`,`vision`,`corevalues`) values 
...
insert  into `account_tbl`(`u_id`,`username`,`password`,`fullname`,`email`,`phone`,`access`,`isDeleted`) values 
(1,'mutya','masa','Mutya Nang Naval','','',1,0),
(2,'arnold','masa','Arnold Ondev','123@gmail.com','',2,0),
(3,'Arno','123123123','123123 123123','123@gmail.com','123123123',2,0);
...
insert  into `announce_tbl`(`a_id`,`an_name`,`an_by`,`an_con`,`an_venue`,`an_time`,`an_date`,`an_posted`) values 
(3,'d','12312','123123','123','09:09 PM','2018-01-19','Arnold Ondev'),
(4,NULL,NULL,NULL,NULL,NULL,'2018-01-31',NULL);
...
insert  into `event_tbl`(`event_id`,`event_name`) values 
(1,'WEDDING'),
(2,'BAPTISM ( SOLO )'),
(3,'BAPTISM ( MANY )'),
(4,'FUNERAL');
...
insert  into `news_tbl`(`news_ID`,`news`,`newsposted`,`newscon`,`newspic`,`newsdate`) values 
(7,'Arnold','Mutya Nang Naval','Lorem ipsum dolor sit amet,1\r\n\r\n\r\n consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','imahe/P Arnold.jpeg','2018-01-20'),
(9,'Adannan','Arnold Ondev','Lorem ipsum dolor sit amet,1\r\n\r\n\r\n consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','imahe/P Adannan8.jpeg','2018-01-20'),
(10,'aspdapsdp','Mutya Nang Naval','Lorem ipsum dolor sit amet,1\r\n\r\n\r\n consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','imahe/P aspdapsdp9.jpeg','2018-01-20'),
(11,'dsa','Mutya Nang Naval','Lorem ipsum dolor sit amet,1\r\n\r\n\r\n consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','imahe/P dsa10.jpeg','2018-01-20');
...
insert  into `prayer_tbl`(`p_id`,`prayername`,`prayercon`,`prayerposted`) values 
(1,'123123123123123','35168115\r\n\r\n\r\n16556','Arnold Ondev');
...
insert  into `reserve_tbl`(`r_id`,`u_id`,`r_name`,`v_id`,`r_date`,`t_id`,`event_id`,`isDeleted`) values 
(1,2,'sadasdasd','1','2018-01-21',1,1,0),
(12,1,'mutya',NULL,'2018-01-31',3,1,0),
(13,1,'mutya',NULL,'2018-01-31',2,4,0);
...
insert  into `sunday_tbl`(`s_id`,`s_name`,`s_con`,`s_bg`,`s_posted`,`s_date`) values 
(2,'a','asd','imahe/P a.jpeg','Arnold Ondev','2018-01-16'),
(3,'ab','asdasd','imahe/P ab2.jpeg','Arnold Ondev','2018-01-15');
...
insert  into `time_tbl`(`t_id`,`t_start`,`t_end`,`event_id`) values 
(1,'08:00 AM','10:00 AM',1),
(2,'11:00 AM','1:00 PM',1),
(3,'2:00 PM','4:00 PM',1),
(4,'8:00 AM','9:30 AM',2),
(5,'10:30 AM','12:00 NN',2),
(6,'1:30 PM','3:00 PM',2),
(7,'11:00 AM','12:00 NN',3),
(8,'8:00 AM','9:00 AM',4),
(9,'10:00 AM','11:00 AM',4),
(10,'12:00 PM','1:00 PM',4),
(11,'1:00 PM','2:00 PM',4),
(12,'2:00 PM','3:00 PM',4);
...
insert  into `venue_tbl`(`v_id`,`v_name`) values 
(1,'Parish'),
(2,'Parish Hall'),
(3,'Kitchen'),
(4,'Youth Center'),
